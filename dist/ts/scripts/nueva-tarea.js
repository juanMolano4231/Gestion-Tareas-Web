...
const tareas = TareasController.getTareas();
window.crear = function () {
    ...
    const nuevaTarea = new Tarea(TareasController.generarId(), titulo, descripcion, estado, TareasController.todaysDate(), grupoIdInput);
